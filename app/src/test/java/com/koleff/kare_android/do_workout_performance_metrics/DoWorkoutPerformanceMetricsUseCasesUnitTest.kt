...
//        )
    ...
    //TODO: move in beforeTest the setup of workout performance metrics 1 and 2...-> nested classes with custom setups for each...
    @RepeatedTest(50)
    fun `save workout exercise set using saveDoWorkoutExerciseSetUseCase`() = runTest {
        ...
        val workoutPerformanceMetrics1 = DoWorkoutPerformanceMetricsDto(
            id = 0,
            workoutId = workout1.workoutId,
            doWorkoutExerciseSets = emptyList(),
            date = Date()
        ...
        val getPerformanceMetricsState2 =
            doWorkoutPerformanceMetricsUseCases.getDoWorkoutPerformanceMetricsUseCase(
                workoutId = workoutPerformanceMetrics1.workoutId
            ).toList()
        ...
        assertTrue { workoutPerformanceMetrics1.copy(id = 1) == fetchedWorkoutPerformanceMetrics2 } //Checking for id auto generating
        ...
        val workoutExerciseSet = DoWorkoutExerciseSetDto(
            ...
            workoutPerformanceMetricsId = fetchedWorkoutPerformanceMetrics2.id,
            workoutId = fetchedWorkoutPerformanceMetrics2.workoutId,
        ...
        val fetchWorkoutExerciseSet =
            doWorkoutPerformanceMetricsUseCases.getDoWorkoutPerformanceMetricsUseCase(
                workoutPerformanceMetrics1.workoutId
            ).toList()
        ...
        assertTrue { workoutPerformanceMetrics1.copy(id = 2) == fetchedWorkoutPerformanceMetrics3 } //Checking for id auto generating
        ...
        val workoutExerciseSet2 = DoWorkoutExerciseSetDto(
            instanceId = UUID.randomUUID(),
            workoutPerformanceMetricsId = fetchedWorkoutPerformanceMetrics3.id,
            workoutId = fetchedWorkoutPerformanceMetrics3.workoutId,
        ...
        val fetchWorkoutExerciseSet2 =
            doWorkoutPerformanceMetricsUseCases.getDoWorkoutPerformanceMetricsUseCase(
                workoutPerformanceMetrics2.workoutId
            ).toList()
