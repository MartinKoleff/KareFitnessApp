...
data class WorkoutUseCases(
    ...
    val favoriteWorkoutUseCase: FavoriteWorkoutUseCase,
    val unfavoriteWorkoutUseCase: UnfavoriteWorkoutUseCase,
    val getFavoriteWorkoutsUseCase: GetFavoriteWorkoutsUseCase,
